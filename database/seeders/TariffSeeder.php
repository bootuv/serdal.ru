    ...
    public function run(): void
    {
        $tariffs = [
            [
                ...
                'features' => [
                    'Занятия 1-на-1 (до 2 участников)',
                    '8 занятий в месяц',
                    'Длительность занятия до 60 минут',
            ...
            [
                ...
                'features' => [
                    'До 6 участников в занятии',
                    '40 занятий в месяц',
                    'Длительность занятия до 90 минут',
                    'Записи занятий, хранение 14 дней',
            ...
            [
                ...
                'features' => [
                    'До 12 участников в занятии',
                    '120 занятий в месяц',
                    'Без лимита длительности занятий',
                    'Записи занятий, хранение 90 дней',
            ...
            [
                ...
                'features' => [
                    'До 25 участников в занятии',
                    '200 занятий в месяц',
                    'Без лимита длительности занятий',
                    'Записи занятий, хранение 180 дней',
                    'Поддомен и брендинг',
