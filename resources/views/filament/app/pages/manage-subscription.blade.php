                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            @if(\App\Services\YooKassaService::recurringEnabled())
                                @if(count(\App\Services\YooKassaService::savableMethods()) === 1)
                                    Привяжите банковскую карту, чтобы оплачивать в один клик и включить
                                    автопродление. Также карту можно сохранить при оплате тарифа.
                                @else
                                    Привяжите способ оплаты, чтобы оплачивать в один клик и включить
                                    автопродление. Также его можно сохранить при оплате тарифа.
                                @endif
                            @else
