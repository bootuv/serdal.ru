<x-filament-widgets::widget>
    <x-filament::section heading="Финансовая статистика"
        description='Расчет ведется с учетом типа оплаты урока. Для "Помесячной оплаты" учитываются все проведенные уроки, для "Поурочной" – только посещенные учениками. Комиссия платформы составляет {{ $commissionPercent }}%. Обратите внимание: расчет носит справочный характер для удобства учителя и не является основанием для финансовых взаиморасчетов.'>
        {{ $this->form }}
