    ...
    <div x-data="{
        ...
        <template x-if="!isTime && diff <= 0">
            <div class="flex flex-col">
                <span class="text-sm font-medium leading-6 text-gray-950 dark:text-white">Статус</span>
                <div class="w-max mt-1">
                    <span class="fi-badge flex items-center justify-center gap-x-1 rounded-md text-xs font-medium ring-1 ring-inset px-2 min-w-[theme(spacing.6)] py-1" style="background-color: rgb(243 244 246); color: rgb(75 85 99); --tw-ring-color: rgb(156 163 175 / 0.2);">
                        Занятие завершено
                    </span>
                </div>
            </div>
